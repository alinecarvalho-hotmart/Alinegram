...
#ifndef ALINEGRAM_SWIFT_H
#define ALINEGRAM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Alinegram",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9Alinegram11AppDelegate")
...
@interface LoginViewController (SWIFT_EXTENSION(Alinegram)) <FUIAuthDelegate>
...
SWIFT_CLASS("_TtC9Alinegram13SceneDelegate")
...
SWIFT_CLASS("_TtC9Alinegram14ViewController")
